...
class Screen:   
    ...
    def drawUI(self):
        level_text = self.font.render("Nr labiryntu:", 1, (250, 250, 250))
        level_text2 = self.font.render(str(self.current_level) +"/388", 1, (250, 250, 250))
        level_grupa = self.font.render("Poziom:",1, (250, 250, 250))
        level_grupa2 = self.font.render(str(self.level.getLevelGroup()) + '/8', 1, (250, 250, 250))
        level_text2 = self.font.render(str(self.current_level) +"/388", 1, (250, 250, 250))
        
        lives_text = self.font.render("Czas:" + str(self.get_current_time()), 1, (250, 250, 250))
        self.screen.blit(level_text, (0, 20))
        self.screen.blit(level_text2, (0, 35))
        self.screen.blit(level_grupa, (0, 60))
        self.screen.blit(level_grupa2, (0, 75))
