...
class Screen:   
    def __init__(self):
        ...
        #Font
        self.font = pygame.font.Font(os.path.join('labirynt/data','impact.ttf'), 36)
        ...
        self.menu_image = pygame.image.load(os.path.join("labirynt/data","Menu2.gif"))
        ...
        self.you_win_image = pygame.image.load(os.path.join("labirynt/data","YouWin.gif"))
        self.instructions = pygame.image.load(os.path.join("labirynt/data","instructions.png"))
    ...
    def drawUI(self):
        level_text = self.font.render("POZIOM " + str(self.current_level) +"/5", 1, (250, 250, 250))
        #lives_text = self.font.render("Czas: " + str(self.get_current_time()), 1, (250, 250, 250))
        self.screen.blit(level_text, (219, 20))
        #self.screen.blit(lives_text, (219, 420))
    ...
    def get_current_time(self):
        value = int(time.time() - self.start_game_time + 10 * self.time_penalty)
